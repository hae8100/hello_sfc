		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "com.sfc",
									"targetURL": "#comsfchellosfc-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsfchellosfc-display": {
								"semanticObject": "comsfchellosfc",
								"action": "display",
								"description": "Test1",
								"title": "com.sfc",
								"signature": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sfc.hellosfc",
									"url": sap.ui.require.toUrl("com/sfc/hellosfc")
								}
							}
						}
					}
